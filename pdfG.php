...
<body style="font-size:16pt; line-height: normal; padding: 0em;" }>
  ...
  <p>จาก&nbsp;&nbsp;&nbsp;<?= $row1["Rank"]; ?>&nbsp;<?= $row1["Under"]; ?>.<?= $row1["pea"]; ?>
    ...
    <br>ตามแผนที่ก่อสร้างได้จ้างเหมา&nbsp;<?= $row2["fname"]; ?>&nbsp;<?= $row2["lname"]; ?>&nbsp;Vender&nbsp;List&nbsp;<?= $ID_vdlist; ?>&nbsp;เลขประจำตัวผู้เสียภาษี&nbsp;<?= $row2["idtax"]; ?>
    <br>ช่วยงานก่อสร้างขยายเขตระบบจำหน่ายไฟฟ้า&nbsp;บริเวณ&nbsp;<?= $row3["Address"]; ?>
    <br>เป็นจำนวนเงิน&nbsp;<?php echo number_format($price, 2); ?>&nbsp;บาท&nbsp;(&nbsp;<?= Convert($price); ?>&nbsp;)&nbsp;รับประกันงาน&nbsp;<?= $row3["avouch"]; ?>&nbsp;วัน&nbsp;นับตั้งแต่วันที่ส่งมอบงานจ้างถูกต้องเรียบร้อยแล้ว&nbsp;เพื่อเป็นหลักประกันการปฏิบัติงานตามเงื่อนไขของใบสั่งจ้าง&nbsp;<?= $row1["Under"]; ?>.<?= $row1["pea"]; ?>&nbsp;จึงขอแจ้งให้&nbsp;<?= $row2["fname"]; ?>&nbsp;<?= $row2["lname"]; ?>&nbsp;วางเงินประกันสัญญาจ้างในอัตราร้อยละ&nbsp;5&nbsp;ของวงเงินการจ้างเหมาทั้งสิ้น&nbsp;คิดเป็นเงินประกัน&nbsp;<?php echo number_format($price*5/100, 2); ?>&nbsp;บาท
    <br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;จึงเรียนมาเพื่อโปรดพิจารณาอนุมัติ
    <br><br><br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?= $row1["Fname"]; ?>&nbsp;<?= $row1["Lname"]; ?>
    <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(&nbsp;<?= $row1["Rank"]; ?>&nbsp;<?= $row1["Under"]; ?>.<?= $row1["pea"]; ?>&nbsp;)
</p>
